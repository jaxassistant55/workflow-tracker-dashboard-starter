---
name: Paid workflow tracker inquiry
about: Request a fixed-scope workflow tracker dashboard sprint
title: "Paid inquiry: workflow tracker dashboard"
...
- Desired statuses:
- Required columns:
- Approximate starter-row count:
- Delivery deadline:

## Scope Acceptance

- [ ] I understand the listed price is $150.
- [ ] I can provide authorized workflow notes or spreadsheet data.
